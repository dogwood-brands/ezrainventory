...
export const mockManualEntries: ManualSpendEntry[] = [
  { id: 'entry-1', locationCode: 'AZ-001', locationName: 'Tucson — Vistoso Plaza', vendor: 'Super Center', category: 'backbar', amount: 142.50, month: 'Apr 2026', uploadedAt: '2026-04-28T14:30:00Z', uploadedBy: 'April C.' },
  { id: 'entry-2', locationCode: 'AZ-003', locationName: 'Oro Valley — La Canada', vendor: 'Leaf & Flower', category: 'service', amount: 890.00, month: 'Apr 2026', uploadedAt: '2026-04-28T14:30:00Z', uploadedBy: 'April C.' },
  { id: 'entry-3', locationCode: 'NV-001', locationName: 'Las Vegas — Arroyo', vendor: 'Enjoy', category: 'retail', amount: 215.00, month: 'Apr 2026', uploadedAt: '2026-04-28T14:30:00Z', uploadedBy: 'April C.' },
  { id: 'entry-4', locationCode: 'AZ-002', locationName: 'Tucson — Saguaro Vista', vendor: 'Johnny B', category: 'backbar', amount: 78.25, month: 'Apr 2026', uploadedAt: '2026-04-28T14:30:00Z', uploadedBy: 'April C.' },
  { id: 'entry-5', locationCode: 'NV-002', locationName: 'Henderson — Marks', vendor: 'Loma', category: 'retail', amount: 312.00, month: 'Apr 2026', uploadedAt: '2026-04-28T14:30:00Z', uploadedBy: 'April C.' },
];
...
export const mockInventoryAging: InventoryAgingItem[] = [
  { id: 'aging-1', sku: 'RF-SH-001', productName: 'Redken Frizz Dismiss Shampoo 10oz', category: 'Retail', locationCode: 'AZ-001', locationName: 'Tucson — Vistoso Plaza', quantityOnHand: 8, daysSinceLastSale: 45, lastSaleDate: '2026-03-22', costValue: 96.00, retailValue: 192.00, agingBand: '30-60' },
  { id: 'aging-2', sku: 'PM-TT-003', productName: 'Paul Mitchell Tea Tree Special Shampoo 33oz', category: 'Retail', locationCode: 'AZ-002', locationName: 'Tucson — Saguaro Vista', quantityOnHand: 4, daysSinceLastSale: 78, lastSaleDate: '2026-02-18', costValue: 72.00, retailValue: 140.00, agingBand: '60-90' },
  { id: 'aging-3', sku: 'JB-POM-002', productName: 'Johnny B Street Cream Pomade', category: 'Retail', locationCode: 'NV-001', locationName: 'Las Vegas — Arroyo', quantityOnHand: 12, daysSinceLastSale: 112, lastSaleDate: '2026-01-15', costValue: 108.00, retailValue: 216.00, agingBand: '90-120' },
  { id: 'aging-4', sku: 'SV-GEL-001', productName: 'Suavecito Firme Hold Gel 32oz', category: 'Retail', locationCode: 'NV-002', locationName: 'Henderson — Marks', quantityOnHand: 6, daysSinceLastSale: 156, lastSaleDate: '2025-12-02', costValue: 54.00, retailValue: 102.00, agingBand: '120+' },
  { id: 'aging-5', sku: 'LF-MSK-001', productName: 'Leaf & Flower CBD Corrective Mask', category: 'Backbar', locationCode: 'AZ-003', locationName: 'Oro Valley — La Canada', quantityOnHand: 3, daysSinceLastSale: 92, lastSaleDate: '2026-02-04', costValue: 135.00, retailValue: 0, agingBand: '90-120' },
  { id: 'aging-6', sku: 'EN-SER-002', productName: 'Enjoy Hair Repair Serum 3.4oz', category: 'Retail', locationCode: 'NM-001', locationName: 'Los Lunas', quantityOnHand: 5, daysSinceLastSale: 67, lastSaleDate: '2026-02-28', costValue: 62.50, retailValue: 125.00, agingBand: '60-90' },
  { id: 'aging-7', sku: 'LM-OIL-001', productName: 'Loma Nourishing Oil Treatment', category: 'Retail', locationCode: 'AZ-001', locationName: 'Tucson — Vistoso Plaza', quantityOnHand: 7, daysSinceLastSale: 134, lastSaleDate: '2025-12-24', costValue: 98.00, retailValue: 196.00, agingBand: '120+' },
];
